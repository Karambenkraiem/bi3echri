...
const VARIANT_CLASSES: Record<Variant, string> = {
  primary:
    'bg-gradient-to-r from-blue-600 to-violet-600 text-white shadow-sm shadow-blue-600/20 hover:from-blue-500 hover:to-violet-500 hover:shadow-md hover:shadow-violet-600/25 focus-visible:ring-blue-500/50',
  secondary:
